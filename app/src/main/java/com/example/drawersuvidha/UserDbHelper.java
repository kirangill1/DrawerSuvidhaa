...
public class UserDbHelper extends SQLiteOpenHelper {
    ...
    COLUMN_NAME + " VARCHAR, " + UserContract.NewUserInfo.COLUMN_ADDRESS +
    ...
    public void addinformations(String customers_name,String email, String customers_address, String aadhar, String pan,
                                String bank_name, String bank_account, String ifsc, Boolean dd_rb,Boolean cheque_rb, String amount,
